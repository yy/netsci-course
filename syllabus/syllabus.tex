...
%{{{ TA
\vspace{-20pt}
{\bfseries Assistant Instructor} \\ Residential: Elise Jing (\texttt{jingy@iu.edu}); Office Hours: Monday 2pm-3pm \\ Online: Jaehyuk Park (\texttt{jp70@iu.edu}); Office Hours: Friday 2pm-3pm
%}}}
...
The course will explore recent advancement of network science, with respect to statistical properties and models of real-world networks, network (graph) algorithms, and practical applications.
Topics include: how information and diseases spread in our society, measures and algorithms for quantifying importance of nodes, link prediction, community detection (clustering), and graph embedding.
...
The course will require a good foundation of mathematics, statistics, programming, algorithms, and data structure although there is no formal prerequisite. 
...
You are of course expected to read reading assignments, attend the classes, and complete quizzes and assignments. 
...
\begin{itemize}%{{{
\item Project proposal due: \textbf{3/1}
\item Project presentation files and final paper due: \textbf{4/27}
\item Project presentation (residential): \textbf{4/27} and \textbf{4/29} 
